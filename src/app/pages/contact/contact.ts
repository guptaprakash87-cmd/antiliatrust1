...
export class Contact {
  ...
  contactInfo: { icon: string; title: string; lines: string[]; image?: string }[] = [
    ...
    { icon: '📧', title: 'Email Us', lines: ['antiliatrust@gmail.com'] },
    { icon: '📞', title: 'Call Us', lines: ['+91 89719 60567'] },
    { icon: '👤', title: 'FOUNDER & CEO', lines: ['MR. OM PRAKASH GUPTA', 'Founder & Chief Executive Officer'], image: '/images/founder_om_prakash_gupta.jpg' },
  ];
